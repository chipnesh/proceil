package me.chipnesh.proceil.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut("within(me.chipnesh.proceil.repository..*)" +
        " || within(me.chipnesh.proceil.service..*)" +
        " || within(me.chipnesh.proceil.web.rest..*)")
