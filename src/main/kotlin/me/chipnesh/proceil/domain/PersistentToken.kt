 ...
 *
 * @see me.chipnesh.proceil.security.PersistentTokenRememberMeServices
 */
@Entity
...
class PersistentToken @JvmOverloads constructor(
    ...
    var userAgent: String? = userAgent
        set(userAgent) {
            field = when {
                userAgent != null && userAgent.length >= MAX_USER_AGENT_LEN -> userAgent.substring(0, MAX_USER_AGENT_LEN - 1)
                else -> userAgent
            }
        }
