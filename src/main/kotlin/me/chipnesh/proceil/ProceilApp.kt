package me.chipnesh.proceil

import me.chipnesh.proceil.config.ApplicationProperties
import me.chipnesh.proceil.config.DefaultProfileUtil
...
class ProceilApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(ProceilApp::class.java)
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ProceilApp>(*args) {
        ...
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ProceilApp::class.java)
