...
import me.chipnesh.proceil.web.rest.errors.EmailNotFoundException
...
class AccountResource(
     ...
     */
    @GetMapping("/account")
    fun getAccount(): UserValueObject {
     ...
     */
    @PostMapping("/account")
    fun saveAccount(@Valid @RequestBody userDTO: UserValueObject) {
