    ...
    return (
      <div>
        <h2 id="service-heading">
          <Translate contentKey="proceilApp.service.home.title">Services</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="proceilApp.service.home.createLabel">Create new Service</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('serviceName')}>
                  <Translate contentKey="proceilApp.service.serviceName">Service Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={this.sort('servicePrice')}>
                  <Translate contentKey="proceilApp.service.servicePrice">Service Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
