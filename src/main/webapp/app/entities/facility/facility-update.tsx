    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="proceilApp.facility.home.createOrEditLabel">
              <Translate contentKey="proceilApp.facility.home.createOrEditLabel">Create or edit a Facility</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : facilityEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="facilityNameLabel" for="facility-facilityName">
