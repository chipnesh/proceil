...
export type IFacilityState = IPaginationBaseState;
...
export class Facility extends React.Component<IFacilityProps, IFacilityState> {
  ...
  render() {
    const { facilityList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="facility-heading">
          <Translate contentKey="proceilApp.facility.home.title">Facilities</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="proceilApp.facility.home.createLabel">Create new Facility</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('facilityName')}>
                  <Translate contentKey="proceilApp.facility.facilityName">Facility Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
...
const mapStateToProps = ({ facility }: IRootState) => ({
  ...
  totalItems: facility.totalItems
});
