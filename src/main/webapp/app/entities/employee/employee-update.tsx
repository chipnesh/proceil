    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="proceilApp.employee.home.createOrEditLabel">
              <Translate contentKey="proceilApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="employeeNameLabel" for="employee-employeeName">
                    <Translate contentKey="proceilApp.employee.employeeName">Employee Name</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="phoneLabel" for="employee-phone">
                    <Translate contentKey="proceilApp.employee.phone">Phone</Translate>
                  </Label>
                  <AvField
                    id="employee-phone"
                    type="text"
