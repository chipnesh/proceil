    ...
    return (
      <div>
        <h2 id="material-heading">
          <Translate contentKey="proceilApp.material.home.title">Materials</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="proceilApp.material.home.createLabel">Create new Material</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('materialName')}>
                  <Translate contentKey="proceilApp.material.materialName">Material Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('materialDescription')}>
                  <Translate contentKey="proceilApp.material.materialDescription">Material Description</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('materialPrice')}>
                  <Translate contentKey="proceilApp.material.materialPrice">Material Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
